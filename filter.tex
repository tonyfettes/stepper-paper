...
\begin{mathpar}
  ...
  \inferrule[S-Filter]{
    \FInstruct{(\ActStep, \GasOne, 0)}{e}{e_i} \\
    \Decompose{e_i}{\mathcal{E}}{\Filter{f}{e_0}} \\
...
\begin{mathpar}
  ...
  \text{\hxf{It depends how you treat instruction transition? They are less important the elimination rules}}\\
...
$\RuleStep{}{}{(a, g)}{d}{d'} \Rightarrow \RuleStep{(a, g)}{d}{d''} \Rightarrow d' = d''$
