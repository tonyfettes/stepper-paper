...
properties like progress and preservation.
...
a variant of the terms in the untyped lambda calculus. Apart from
constructs like variables, applications, and lambdas, it also includes
some new constructs: a match-all pattern \(\PatExpr\) and a value pattern
...
\item \emph{Instrumentation}. \label{num:simple_example_instrument} In this
  ...
  \lstinline[language=hazel]{\$v}. The former matches against any
