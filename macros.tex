...
%%% Inline code command with background
\newcommand{\code}[1]{{\fboxsep=1.5pt\colorbox{codebg}{\texttt{\small #1}}}}
...
\DeclareMathOperator{\DefLvl}{Priority}
