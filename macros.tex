...
% Pat
\newcommand{\PatExpr}{\mathsf{\$e}}
\newcommand{\PatValue}{\mathsf{\$v}}
...
\newcommand{\RuleSkip}[2]{#1 \twoheadrightarrow #2}
\newcommand{\RuleStep}[2]{#1 \mapsto #2}
\newcommand{\RulePaused}[2]{#1 \twoheadrightarrow^{\ast}_{p} #2}
\newcommand{\RuleValue}[2]{#1 \twoheadrightarrow^{\ast}_{v} #2}
\newcommand{\RuleStepN}[3]{#1 \mapsto^{#3} #2}
