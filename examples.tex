...
\begin{figure}
  ...
  \begin{minipage}{.40\linewidth}
    \begin{subfigure}{\linewidth}
      \includegraphics[scale=0.34]{images/eg11.png}
  ...
  \begin{minipage}{.57\linewidth}
    \begin{subfigure}{\linewidth}
      \includegraphics[scale=0.34]{images/eg12.png}
...
\begin{figure}
  ...
  \begin{minipage}{.40\linewidth}
    \begin{subfigure}{\linewidth}
      \includegraphics[scale=0.34]{images/eg21.png}
  ...
  \begin{minipage}{.57\linewidth}
    \begin{subfigure}{\linewidth}
      \includegraphics[scale=0.34]{images/eg22.png}
...
for pattern matching (\fbox{\(\Matches{p}{e}\)}).
