...
complete trace for this program: each line corresponds to one
...
\begin{figure}
  ...
  \begin{subfigure}{0.57\linewidth}
    ...
    \caption{Full stepper trace. Each line is one small-step transition. The green highlight at the bottom marks where the next step will be taken.}
    \label{fig:full-trace}
  \end{subfigure}
  \caption{The stepper used on a list map example.}
\end{figure}

However, the full trace can be distracting---for this small program it
already contains many steps, most of which are routine substitutions
and arithmetic that do not help the reader understand \code{map}.
