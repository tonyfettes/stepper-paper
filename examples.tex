...
intuition behind the map function, we can hide all steps except 
those that show the application of the map function, by inserting a
...
\ldots Note that this \verb|debug| statement overrides the \verb|pause| and
\verb|eval| statement because of the dynamic scoping of filters, which
is achieved by instructing the expression every step and selecting the
